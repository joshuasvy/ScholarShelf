...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex bg-primary items-center justify-center">
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl px-8 md:px-24 lg:px-28 py-12 flex flex-col justify-center bg-white shadow-xl rounded-md">
